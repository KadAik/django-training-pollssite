...
class Dev(Configuration):
    ...
    SECRET_KEY = 'django-insecure-a-nyf(a)l%p=2p)k%6m!w7ktzzapg*g#c1r(m9b$!9a6j%%uk5'
    ...
    INSTALLED_APPS = [
        ...
        # The following has been commented in order to test authdemo
